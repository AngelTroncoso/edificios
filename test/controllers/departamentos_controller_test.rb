...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference("Departamento.count") do
      post departamentos_url, params: { departamento: { edificio_id: @departamento.edificio_id, numero: @departamento.numero } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { edificio_id: @departamento.edificio_id, numero: @departamento.numero } }
